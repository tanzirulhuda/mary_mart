...
<?php require_once("includes/header.php") ?>
		...
		<div class="container">
			...
			<div class="about-tp">
				...
				<div class="col-md-4 about-agileits-w3layouts-right">
					...
					<h4>Mary Mart</h4>
					<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. A qui ipsa hic!</p>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
	...
	<div class="copy-right">
		<div class="container">
			<p>© Mary Mart. All rights reserved | Design by
				<a href="http://w3layouts.com"> Apps Valley.</a>
			</p>
		</div>
	</div>
