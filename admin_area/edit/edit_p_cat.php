...
<?php 
    ...
    if(isset($_GET['edit_p_cat'])){
        ...
        $edit_p_cat_query = "select * from product_categories where id='$edit_p_cat_id'";
...
<?php  
          ...
          if(isset($_POST['update'])){
              ...
              $update_p_cat = "update product_categories set cat_name='$p_cat_title' where id='$p_cat_id'";
